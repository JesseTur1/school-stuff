...
int main()
{
	...
	else if (valinta == 2)
	{
		...
		if (perc > 50)
		{
			cout << "hinta on : " << hinta/perc << " , ja sen on alle puolet alkuper‰isest‰ hinnasta";
		}
		else
		{
	...
	else if (valinta == 3)
	{
		...
		if (lasku == 1)
		{
			double eka;
			double toka;
			cout << "kerro kaksi lukua. Mielell‰‰n kokonaista" << endl;
			cin >> eka;
			cin >> toka;
	...
	else if (valinta == 4)
	{
		...
		else
		{
			if (remainder(uno, dos) == 0)
			{
				if (uno > dos)
				{
					cout << "ovat t‰ydellisesti jaollisia, sek‰ " << uno << " on suurempi luku";
				}

				if (uno < dos)
				{
					cout << "ovat t‰ydellisesti jaollisia, sek‰ " << dos << " on suurempi luku";
				}
	...
	{
		cout << "laskin. Kerro kaksi lukua, ja sen j‰lkeen operaation merkki. +,-,/,* " << endl;
		double luku1;
		double luku2;
		char merkki;
	...
	else if (valinta == 12)
	{
		int x;
		int z;
		cout << "tehd‰‰n neliˆ, kerro kui suuri (x sit z)" << endl;
		do
		{
			cin >> x;
			cin >> z;
